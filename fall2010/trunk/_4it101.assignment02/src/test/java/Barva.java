...
//== KONSTANTNÍ ATRIBUTY TŘÍDY =================================================
    ...
    private static final List<Barva> seznamBarev = new ArrayList<Barva>( 32 );
    ...
    ČERVENÁ = new Barva( Color.RED,             "červená" );
    ...
    /** Azurová = RGBA( 0, 255, 255, 255); <br> Lze pro ni použít i
     *  textový název "blankytná". */           public static final Barva
    ...
    //=== Barvy bez ekvivalentních konstant in java.awt.Color
    ...
    /** Žádná = RGBA( 0,0,0,0) - PRŮHLEDNÁ! */   public static final Barva
...
//== KONSTANTNÍ ATRIBUTY INSTANCÍ ==============================================
    ...
    /** Odpovídající barva jako instance třídy {@link java.awt.Color}. */
...
//== PŘÍSTUPOVÉ METODY VLASTNOSTÍ TŘÍDY ========================================
    ...
    /***************************************************************************
     * Vrátí kolekci řetězců doposud definovaných názvů barev.
     * Názvů barev je více než definovaných barev, protože barvy mohou mít
     * více názvů (a některé jich opravdu mají několik).
     *
     ...
     *
     * @return  Pole řetězců s názvy znamých barev
     */
...
//== KONSTRUKTORY A TOVÁRNÍ METODY =============================================
     ...
     * {@link java.awt.Color} se zadaným českým názvem.
     *
    ...
    private Barva( Color c, String název )
    {
        ...
        název2barva.put( název, this );
        color2barva.put( color, this );
        seznamBarev.add( this );
...
//== PŘÍSTUPOVÉ METODY VLASTNOSTÍ INSTANCÍ =====================================
     ...
     * Metoda je používaná ve třídě {@link SprávcePlátna}.
     *
...
//== OSTATNÍ NESOUKROMÉ METODY INSTANCÍ ========================================
    ...
    public Barva průsvitná()
    {
        ...
        if (barva == null) {
            ...
            if (barva == null) {
                barva = getBarva(color.getRed(),  color.getGreen(),
     ...
     * chybám nejsou oparace průhlednější a neprůhlednější zcela reverzní.
     *
     ...
     * chybám nejsou oparace světlejší a tmavší zcela reverzní.
     *
...
//== SOUKROMÉ A POMOCNÉ METODY INSTANCÍ ========================================
    ...
    /***************************************************************************
     * Obsahuje-li název diakritiku, uloží do příslušné mapy
